...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <form action="{{ route('crud.create') }}" method="POST" class="flex gap-3">
                @csrf
                ...
                <tbody class="divide-y">
                    @forelse ($data as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600">{{ $item->created_at->format('Y-m-d H:i') }}
                            </td>
                            <td class="px-6 py-4 text-center">
                                <button
                                    class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded mr-2 text-sm">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl card-shadow p-8 fade-in sticky top-8">
                    ...
                    <form action="{{route('crud.create')}}" method="POST" class="space-y-6">
                        @csrf
                        <div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                               ...
                               @foreach ($data as $item )
                                    ...
                                    <tr class="table-row">
                                        <td class="py-4 px-4">
                                            <span class="bg-indigo-100 text-indigo-700 font-bold px-3 py-1 rounded-lg text-sm">{{ $item->id }}</span>
                                        </td>
                                        <td class="py-4 px-4">
                                            <div class="flex items-center">
